...
# print(torch.version.cuda)  #should print the CUDA version if supported
...
def save_checkpoint(epoch, batch, feature_extractor, decoder, optimizer, loss, checkpoint_dir="checkpoints"):
...
for epoch in range(start_epoch, num_epochs):
    ...
    # save checkpoint
    save_checkpoint(epoch + 1, "end", feature_extractor, decoder, optimizer, loss.item())


    print(f"Epoch [{epoch+1}/{num_epochs}], Loss: {loss.item():.4f}")

torch.save(feature_extractor.state_dict(), "models/feature_extractor_trained.pth")

torch.save(decoder.state_dict(), "models/decoder_trained.pth")
